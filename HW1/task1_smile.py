...
row_1 = firstSymbol*2 + secondSymbol + firstSymbol*4 + secondSymbol + \
        firstSymbol*2
row_2 = firstSymbol + secondSymbol*3 + firstSymbol*2 + secondSymbol*3 + \
        firstSymbol
row_3 = row_1
row_4 = firstSymbol*10
row_5 = secondSymbol*2 + firstSymbol*6 + secondSymbol*2
row_6 = firstSymbol + secondSymbol*2 + firstSymbol*4 + secondSymbol*2 + \
        firstSymbol
